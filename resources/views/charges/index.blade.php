...
<style>
    ...
    .modal-sheet { width:min(640px,100%); margin:1rem auto 2rem; background:linear-gradient(160deg,rgba(84,0,11,.98),rgba(45,0,6,.99)); border:1px solid rgba(94,200,179,.35); border-radius:18px; box-shadow:0 20px 60px rgba(0,0,0,.55); padding:1.35rem 1.5rem; }
