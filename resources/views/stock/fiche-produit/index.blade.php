...
<style>
    ...
    .icon-btn { width:34px; height:34px; border-radius:9px; border:1px solid rgba(201,164,92,.3); background:rgba(0,0,0,.3); color:var(--gold); display:inline-flex; align-items:center; justify-content:center; cursor:pointer; }
    .icon-btn.danger:hover { color:#ff9a9a; border-color:rgba(255,100,100,.5); }
    .icon-btn svg { width:16px; height:16px; }
    .modal-backdrop { position:fixed; inset:0; background:rgba(10,0,2,.72); backdrop-filter:blur(6px); z-index:200; display:none; align-items:center; justify-content:center; padding:1rem; }
    .modal-backdrop.open { display:flex; }
    .modal-sheet { width:min(560px,100%); background:linear-gradient(160deg,rgba(84,0,11,.97),rgba(45,0,6,.98)); border:1px solid rgba(201,164,92,.35); border-radius:18px; padding:1.5rem; box-shadow:0 20px 60px rgba(0,0,0,.55); }
    .modal-header { display:flex; align-items:center; justify-content:space-between; margin-bottom:1.25rem; padding-bottom:.85rem; border-bottom:1px solid rgba(201,164,92,.2); }
    ...
    .field input { width:100%; padding:.7rem .85rem; border-radius:10px; border:1px solid rgba(201,164,92,.3); background:rgba(0,0,0,.35); color:#fff; font-family:inherit; font-size:.92rem; outline:none; }
    .field input:disabled,.field input[readonly] { opacity:.7; }
    .modal-footer { display:flex; justify-content:flex-end; gap:.65rem; margin-top:1.25rem; padding-top:1rem; border-top:1px solid rgba(201,164,92,.18); }
