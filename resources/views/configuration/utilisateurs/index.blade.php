...
<style>
    ...
    .btn-gold {
        ...
        color:var(--burgundy-deep); box-shadow:0 4px 16px rgba(201,164,92,.3);
    }
    .btn-gold:hover { transform:translateY(-1px); box-shadow:0 6px 20px rgba(201,164,92,.4); }
    .btn-ghost {
    ...
    .table-wrap {
        ...
        border:1px solid rgba(201,164,92,.22); background:rgba(0,0,0,.22);
        box-shadow:inset 0 1px 0 rgba(201,164,92,.08);
    }
    .users-table {
    ...
    .users-table tbody tr:hover td { background:rgba(201,164,92,.1) !important; }
    ...
    .user-avatar {
        ...
        background:linear-gradient(145deg,#e8d5a8,#c9a45c);
        border:1px solid rgba(201,164,92,.55);
        box-shadow:0 0 0 2px rgba(201,164,92,.12);
    }
    ...
    .user-sub {
        font-size:.7rem; color:rgba(232,213,168,.65); margin-top:.15rem;
        white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:180px;
    }
    ...
    .users-table .badge-statut.directeur { background:rgba(201,164,92,.28); border-color:rgba(201,164,92,.65); color:#fff; }
    ...
    .login-pill {
        ...
        background:rgba(0,0,0,.35); border:1px solid rgba(201,164,92,.22);
        font-family:ui-monospace, Consolas, monospace;
        font-size:.78rem; color:var(--gold-light);
    }
    .pwd-mask {
        letter-spacing:.18em; color:rgba(255,255,255,.55); font-size:.85rem;
    }
    ...
    .auth-chip {
        ...
        background:rgba(201,164,92,.1); border:1px solid rgba(201,164,92,.28);
    ...
    .auth-empty { font-size:.78rem; color:rgba(255,255,255,.35); }
    ...
    .icon-btn {
        ...
        border:1px solid rgba(201,164,92,.3); background:rgba(0,0,0,.3);
    ...
    .modal-backdrop {
        position:fixed; inset:0; background:rgba(10,0,2,.72); backdrop-filter:blur(6px);
    ...
    .modal-sheet {
        ...
        border:1px solid rgba(201,164,92,.35); border-radius:18px;
        box-shadow:0 20px 60px rgba(0,0,0,.55), 0 0 40px rgba(201,164,92,.12);
        padding:1.5rem;
    }
    .modal-header {
        display:flex; align-items:center; justify-content:space-between;
    ...
    .field input, .field select {
        ...
        border:1px solid rgba(201,164,92,.3); background:rgba(0,0,0,.35);
    ...
    .auth-box {
        border:1px solid rgba(201,164,92,.22); border-radius:12px;
        padding:.9rem 1rem; background:rgba(0,0,0,.22);
    }
    .auth-select-all {
    ...
    .check-item {
        ...
        font-size:.85rem; color:rgba(255,255,255,.8); cursor:pointer;
    }
    .check-item input { width:15px; height:15px; accent-color:var(--gold); }
    .modal-footer {
        display:flex; justify-content:flex-end; gap:.65rem;
        margin-top:1.25rem; padding-top:1rem; border-top:1px solid rgba(201,164,92,.18);
    }
    .empty-row td { text-align:center !important; color:rgba(255,255,255,.45); padding:2.2rem !important; }
