...
<style>
    ...
    .chip {
        ...
        font-size: 0.75rem; background: rgba(201,164,92,0.12);
        border: 1px solid rgba(201,164,92,0.28); color: var(--gold-light);
    }
    .page-note {
        color: rgba(255,255,255,0.45); font-size: 0.82rem; margin-bottom: 0.85rem;
    }
