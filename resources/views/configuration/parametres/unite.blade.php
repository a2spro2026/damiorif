...
<div class="content-panel fiche-page">
    ...
    <p class="page-note">Unités saisies automatiquement depuis les articles (bons d'achat / vente).</p>
    <div class="table-wrap">
        <table class="data-table">
            ...
            <tbody>
                ...
                @empty
                    <tr class="empty-row"><td colspan="4">Aucune unité enregistrée.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
